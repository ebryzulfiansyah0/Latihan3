...
- s1esuaikan komputer anda tapi saya saran kan memakai yg 64bit jika kalian bisa
...
- ![repolokal](https://github.com/alviandwipramono/massvian/blob/master/gmbr/mkdir.PNG)File README.md berhasil dibuat. 
...
- ![Filebaru](https://github.com/alviandwipramono/massvian/blob/master/gmbr/echo.PNG)

## Menambahkan File baru pada repository
- Untuk menambahkan file yang baru saja dibuat tersebut gunakan perintah git add.
- File README.md berhasil ditambahkan. 
- $ git add README.md
- ![Gitadd](https://github.com/alviandwipramono/massvian/blob/master/gmbr/mm.png)

## Commit (Menyimpan perubahan ke database)
- Untuk menyimpan perubahan yang ada kedalam database repository local, gunakan perintah git commit -m “komentar commit”
- Perubahan berhasil disimpan.
- $ git commit -m “File pertama saya”
- ![gitcommit](https://github.com/alviandwipramono/massvian/blob/master/gmbr/pw.png)
...
- ![gitpushorigin](https://github.com/alviandwipramono/massvian/blob/master/gmbr/origin%20master.PNG)
## Clone Repository
- Clone repository, pada dasarnya adalah meng-copy repository server dan secara otomatis membuat satu direktory sesuai dengan nama repositorynya (working directory).
- Untuk melakukan cloning, gunakan perintah git clone [url]
- ![clone](https://github.com/alviandwipramono/massvian/blob/master/gmbr/clone.PNG)
